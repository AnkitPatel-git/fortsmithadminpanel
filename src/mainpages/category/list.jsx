...
import { categryGrid } from '../../data/dummy';
    ...
    return (
        ...
        <div className='bg-white shadow-lg max-w-[1100px] my-5 mx-auto p-5'>
            <div className='flex justify-between my-3'>
                <h1 className='text-3xl font-bold m-4'>Category List</h1>
                <NavLink to="/Addcategory"> <button className='text-white px-5 py-2 font-semibold rounded-lg' style={{ backgroundColor: "#03c9d7" }}>+ New Category</button></NavLink>
            ...
            >
                <ColumnsDirective>
                    ...
                    {categryGrid.map((item, index) => <ColumnDirective key={index} {...item} />)}
                </ColumnsDirective>
